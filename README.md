...
- Склонируйте репозиторий:
  ...
  ```shell
  git clone https://github.com/Rap82/Goit_HW_web__DZ_8_1.git
  ```
...
├── Pipfile
├── authors.json            # Файл авторів для внесення в базу
├── quotes.json             # Файл цитат для внесення в базу
├── config.ini              # Налаштування підключення до бази даних
├── README.MD               # Інструкція для використання.
